...
<style  scoped>
#detailContent{position :absolute;top:0;left : 0; background: #fff; z-index: 99; min-height: 100%;width: 100%}
#detailContent.slide-enter-active{ animation:.3s slideMove;}
@keyframes slideMove{
